...
INSERT INTO orders (id, status, version, user_id, created_at) VALUES
  ('e3f2a1b4-c5d6-4e7f-8a9b-0c1d2e3f4a5b', 'INVENTORY_APPROVED', 0, '00000000-0000-0000-0000-000000000001', NOW() - INTERVAL '4 days');
...
INSERT INTO orders (id, status, version, user_id, created_at) VALUES
  ('9c8d7e6f-5a4b-4c3d-2e1f-0a9b8c7d6e5f', 'INVENTORY_REJECTED', 0, '00000000-0000-0000-0000-000000000001', NOW() - INTERVAL '2 days 5 hours');
INSERT INTO order_items (id, order_id, product_id, quantity, price) VALUES
...
-- Order 3: Happy path – Abbey Road x2 + Jailbreak x1 (1 day ago)
INSERT INTO orders (id, status, version, user_id, created_at) VALUES
  ('2f4d6b8a-0e2c-4a4e-8f0b-2c4e6a8c0e2a', 'INVENTORY_APPROVED', 0, '00000000-0000-0000-0000-000000000001', NOW() - INTERVAL '7 hours');
INSERT INTO order_items (id, order_id, product_id, quantity, price) VALUES
...
INSERT INTO orders (id, status, version, user_id, created_at) VALUES
  ('b7c8d9e0-f1a2-4b3c-4d5e-6f7a8b9c0d1e', 'PAYMENT_FAILED', 0, '00000000-0000-0000-0000-000000000001', NOW() - INTERVAL '14 hours');
INSERT INTO order_items (id, order_id, product_id, quantity, price) VALUES
...
-- Order 5: Cancelled (timeout) – Dire Straits Making Movies (7 hours ago)
INSERT INTO orders (id, status, version, user_id, created_at) VALUES
  ('7a8b9c0d-1e2f-4a3b-5c6d-7e8f9a0b1c2d', 'CANCELLED', 0, '00000000-0000-0000-0000-000000000001', NOW() - INTERVAL '1 day 8 hours');
INSERT INTO order_items (id, order_id, product_id, quantity, price) VALUES
...
INSERT INTO orders (id, status, version, user_id, created_at) VALUES
  ('4d5e6f7a-8b9c-4d0e-1f2a-3b4c5d6e7f8a', 'INVENTORY_REJECTED', 0, '00000000-0000-0000-0000-000000000001', NOW() - INTERVAL '2 hours');
INSERT INTO order_items (id, order_id, product_id, quantity, price) VALUES
